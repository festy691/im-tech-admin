                    ...
                    <v-table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-right">{{order.user.phonenumber}}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="text-right">{{ order.country.name }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <div class="py-4">
                                    ...
                                    <template v-if="order.cardType === 'Physical Card'">
                                        <span class="py-4"><h4>Card Images:</h4></span>
                                        <v-row>
                                            <v-col cols="6" md="6" v-for="(file, index) in order.files" :key="index">
                                    ...
                                    <div v-else-if="order.cardType === 'E-Card' || order.cardType === 'E-Code'">
                                        <span class="pa-4"><h4>Card Numbers:</h4></span>
                                        <v-row class="pa-4">
                                            <v-col v-for="(card, index) in order.cardNumber" :key="index">
                                            <span><h4>{{ card }}</h4></span>
                                            </v-col>
                                        </v-row>
                                    </div>
